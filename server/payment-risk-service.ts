...
export function getOzowIntegrationDiagnostics() {
  ...
  return {
    ...
    payinSuccessReturnUrl: publicUrl ? `${publicUrl.replace(/\/$/, "")}/api/ozow/return/success` : null,
    payinCancelReturnUrl: publicUrl ? `${publicUrl.replace(/\/$/, "")}/api/ozow/return/cancel` : null,
    payinErrorReturnUrl: publicUrl ? `${publicUrl.replace(/\/$/, "")}/api/ozow/return/error` : null,

...
export const notificationTypeEnum = pgEnum("notification_type", [
  ...
  // Driver depot orders (B2B refuel)
...
/** Email/password credentials; `id` matches `profiles.id` (see `auth-local` / `auth`). */
...
export const suppliers = pgTable("suppliers", {
  ...
  status: supplierStatusEnum("status").default("pending_compliance"),
  registrationNumber: text("registration_number"),
  directorNames: text("director_names").array(),
  registeredAddress: text("registered_address"),
  vatNumber: text("vat_number"),
  vatCertificateExpiry: timestamp("vat_certificate_expiry"),
  sarsTaxNumber: text("sars_tax_number"),
  taxClearanceNumber: text("tax_clearance_number"),
  ...
  wholesaleLicenseIssueDate: timestamp("wholesale_license_issue_date"),
  dmreLicenseExpiry: timestamp("dmre_license_expiry"),
  allowedFuelTypes: text("allowed_fuel_types").array(),
  siteLicenseNumber: text("site_license_number"),
  depotAddress: text("depot_address"),
  permitNumber: text("permit_number"),
  permitExpiryDate: timestamp("permit_expiry_date"),
  environmentalAuthNumber: text("environmental_auth_number"),
  approvedStorageCapacityLitres: integer("approved_storage_capacity_litres"),
  fireCertificateNumber: text("fire_certificate_number"),
  fireCertificateIssueDate: timestamp("fire_certificate_issue_date"),
  fireCertificateExpiryDate: timestamp("fire_certificate_expiry_date"),
  hseFileVerified: boolean("hse_file_verified").default(false),
  hseFileLastUpdated: timestamp("hse_file_last_updated"),
  spillComplianceConfirmed: boolean("spill_compliance_confirmed").default(false),
  sabsCertificateNumber: text("sabs_certificate_number"),
  sabsCertificateIssueDate: timestamp("sabs_certificate_issue_date"),
  sabsCertificateExpiryDate: timestamp("sabs_certificate_expiry_date"),
  calibrationCertificateNumber: text("calibration_certificate_number"),
  calibrationCertificateIssueDate: timestamp("calibration_certificate_issue_date"),
  calibrationCertificateExpiryDate: timestamp("calibration_certificate_expiry_date"),
  publicLiabilityPolicyNumber: text("public_liability_policy_number"),
  publicLiabilityInsuranceProvider: text("public_liability_insurance_provider"),
  publicLiabilityCoverageAmountRands: integer("public_liability_coverage_amount_rands"),
  publicLiabilityPolicyExpiryDate: timestamp("public_liability_policy_expiry_date"),
  envInsuranceNumber: text("env_insurance_number"),
  envInsuranceExpiryDate: timestamp("env_insurance_expiry_date"),
...
export const drivers = pgTable("drivers", {
  ...
  status: driverStatusEnum("status").default("pending_compliance"),
  ...
  prdpRequired: boolean("prdp_required").default(false),
  prdpCategory: text("prdp_category"),
  prdpIssueDate: timestamp("prdp_issue_date"),
  prdpExpiry: timestamp("prdp_expiry"),
  dgTrainingRequired: boolean("dg_training_required").default(false),
  dgTrainingProvider: text("dg_training_provider"),
  dgTrainingCertificateNumber: text("dg_training_certificate_number"),
  dgTrainingIssueDate: timestamp("dg_training_issue_date"),
  dgTrainingExpiryDate: timestamp("dg_training_expiry_date"),
  criminalCheckStatus: text("criminal_check_status").default("pending"),
  criminalCheckDone: boolean("criminal_check_done").default(false),
...
export const vehicles = pgTable("vehicles", {
  ...
  vehicleStatus: vehicleStatusEnum("vehicle_status").default("pending_compliance"),
  vehicleRegCertificateNumber: text("vehicle_reg_certificate_number"),
  licenseDiskExpiry: timestamp("license_disk_expiry"),
  roadworthyExpiry: timestamp("roadworthy_expiry"),
  roadworthyCertificateNumber: text("roadworthy_certificate_number"),
  roadworthyIssueDate: timestamp("roadworthy_issue_date"),
  dgVehiclePermitRequired: boolean("dg_vehicle_permit_required").default(false),
  dgVehiclePermitNumber: text("dg_vehicle_permit_number"),
  dgVehiclePermitIssueDate: timestamp("dg_vehicle_permit_issue_date"),
  dgVehiclePermitExpiryDate: timestamp("dg_vehicle_permit_expiry_date"),
  vehicleInsured: boolean("vehicle_insured").default(false),
  insuranceProvider: text("insurance_provider"),
  policyNumber: text("policy_number"),
  policyExpiryDate: timestamp("policy_expiry_date"),
  insuranceExpiry: timestamp("insurance_expiry"),
  loaRequired: boolean("loa_required").default(false),
  loaIssueDate: timestamp("loa_issue_date"),
  loaExpiryDate: timestamp("loa_expiry_date"),
...
export const documents = pgTable("documents", {
  ...
  documentIssueDate: timestamp("document_issue_date"),
